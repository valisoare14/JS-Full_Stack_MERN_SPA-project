        ...
        if(docnumber==0){
            try {
                ...
                for(let symbol of symbols){
                    ...
                    currentPrices.push({'price_change_percentage_24h':result.dp,'name':names[symbols.indexOf(symbol)],'symbol':symbol,'current_price':Number(result.c).toFixed(2),'image':result_.logo,"market":"stocks"})
                }
